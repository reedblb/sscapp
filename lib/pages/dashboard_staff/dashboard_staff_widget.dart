...
import 'dashboard_staff_model.dart';
export 'dashboard_staff_model.dart';

class DashboardStaffWidget extends StatefulWidget {
  const DashboardStaffWidget({super.key});

  @override
  State<DashboardStaffWidget> createState() => _DashboardStaffWidgetState();
}

class _DashboardStaffWidgetState extends State<DashboardStaffWidget>
    with TickerProviderStateMixin {
  late DashboardStaffModel _model;
