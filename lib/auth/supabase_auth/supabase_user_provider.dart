...
class StudentSuccessCentreHubSupabaseUser extends BaseAuthUser {
  StudentSuccessCentreHubSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> studentSuccessCentreHubSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          StudentSuccessCentreHubSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
