...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    studentSuccessCentreHubAuthUserSubject.add(
      StudentSuccessCentreHubAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<StudentSuccessCentreHubAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  StudentSuccessCentreHubAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = StudentSuccessCentreHubAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    studentSuccessCentreHubAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
StudentSuccessCentreHubAuthUser? currentUser;
